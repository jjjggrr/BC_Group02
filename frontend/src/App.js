...
function App() {
    ...
    const handleInitiateTransfer = async (e) => {
        ...
        try {
            ...
            // Check if asset exists (using the new variable name)handleInitiateTransfer
